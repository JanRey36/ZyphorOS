  ...
  head: () => ({
    meta: [
      ...
      { title: "Zyphor OS — Learn Linux From The Inside Out" },
      {
        name: "description",
        content:
          "Zyphor OS is a modern, learning-oriented Linux distribution based on Debian and Kali. Minimal, developer-focused, and built for those who want to understand their system.",
      },
